module.exports = {
  ...
  scopes: [
    { name: 'coral', description: 'anything @divetool/coral related' },
    {
      name: 'coral-tokens',
      description: 'anyting @divetool/coral-tokens related',
    },
    {
      name: 'coral-angular',
      description: 'anyting @divetool/coral-angular related',
    },
    {
      name: 'coral-react',
